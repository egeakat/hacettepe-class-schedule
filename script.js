...
function addClass(name, hours) {
    ...
    hours.forEach((element) => {
        ...
        if (tableBody.children[row].children[col].innerHTML != "") {
            alert(
                "Classes are overlapping. Erasing the previous added class in clashing hours " +
...
function seeder() {
    removeClass(addClass("FIZ117(25-26) <br> LS1, LS2", [10, 11, 12]), [
        10,
        11,
        12,
    ]);
    removeClass(addClass("ING112(27, 32, 36) <br> D4", [14, 15, 16]), [
        14,
        15,
        16,
    ]);
    removeClass(addClass("ING212(27) <br> A210(60) ", [40, 41, 42]), [
        40,
        41,
        42,
    ]);
    ...
    removeClass(addClass("BBM234(01,02) <br> D1, D2", [14, 15, 16]), [
        14,
        15,
        16,
    ]);
    removeClass(
        addClass("MAT124(01,10,14) <br> D1, D2, D3", [21, 22, 41, 42, 50, 51]), [21, 22, 41, 42, 50, 51]
    );
    removeClass(addClass("BBM384(01-02) <br> D8, D9", [44, 45]), [44, 45]);
    removeClass(addClass("BBM428 <br> M9", [16, 17]), [16, 17]);
    removeClass(addClass("BBM497 <br> D10", [14, 15]), [14, 15]);
    removeClass(addClass("FIZ138(25-26) <br> D1, D2", [24, 25, 44, 45]), [
        24,
        25,
        44,
        45,
    ...
    removeClass(addClass("BBM202(01-02-03) <br> D3,D4,D8", [24, 25, 26]), [
        24,
        25,
        26,
    ]);
    ...
    removeClass(addClass("BBM102(01,02,03) <br> D1, D2, D3", [34, 35, 36]), [
        34,
        35,
        36,
    ]);
    removeClass(addClass("ELE296 <br> M13", [30, 31, 32, 33]), [30, 31, 32, 33]);
    removeClass(addClass("BBM416 <br> D9", [14, 15, 16]), [14, 15, 16]);
    ...
    removeClass(addClass("BBM342(01-02) <br> D8, D9", [30, 31, 32]), [
        30,
        31,
        32,
    ]);
    removeClass(addClass("BBM382(01-02) <br> D8, D9", [40, 41, 42]), [
        40,
        41,
        42,
    ]);
    removeClass(addClass("BBM406 <br> D10", [30, 31, 17]), [30, 31, 17]);
    removeClass(addClass("BBM486 <br> D10", [50, 51, 52]), [50, 51, 52]);
    removeClass(addClass("BBM409 <br> D10", [57, 58]), [57, 58]);
    removeClass(addClass("BBM405 <br> D8", [34, 35, 36]), [34, 35, 36]);
    removeClass(addClass("BBM418 <br> D9 ", [47, 48]), [47, 48]);
    removeClass(addClass("BBM442 <br> D9", [44, 45, 46]), [44, 45, 46]);
    removeClass(addClass("BBM467 <br> D8", [20, 21, 22]), [20, 21, 22]);
    removeClass(addClass("BBM469 <br> D8 ", [37, 38]), [37, 38]);
    ...
    removeClass(addClass("İST292(05-06) <br> D3, D4", [50, 51, 52]), [
        50,
        51,
        52,
    ]);
